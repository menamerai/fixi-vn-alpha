...
import { BrushRounded, HistoryOutlined, SignalCellularNull } from "@material-ui/icons";
...
const NavBar = () => {
  ...
  const handleClose = event => {
    ...
    /*switch (event.currentTarget.id.match(/-[\s\S]+/)) {
      case "news-news1":
        history.push("/news1");
        break;
      case "news-news2":
    ...
    const btnClicked = event.currentTarget.id.match(/-[\s\S]+/gi);
    if (btnClicked) {
      ...
      <Toolbar variant="dense" id="navbar" component="nav">
        <Box className="buttons">
          ...
          <Menu
            ...
            transformOrigin={{ vertical: "top", horizontal: "center" }}
          >
            <MenuItem id="career-career1" onClick={handleClose}>Career1</MenuItem>
            <MenuItem id="career-career2" onClick={handleClose}>Career2</MenuItem>
          </Menu>
          <Button
            endIcon={<ExpandMoreIcon />}
            size="small"
          ...
          <Menu
            ...
            transformOrigin={{ vertical: "top", horizontal: "center" }}
          >
            <MenuItem id="story-story1" onClick={handleClose}>Story1</MenuItem>
            <MenuItem id="story-story2" onClick={handleClose}>Story2</MenuItem>
          </Menu>
        </Box>
        <Box classname="icons">
          <ExpandMoreIcon />
